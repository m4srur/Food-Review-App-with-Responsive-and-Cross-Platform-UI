...
for(c=d.values&&d.values.length||1,e.length>c&&(e.slice(c).remove(),e=e.slice(0,c)),b=e.length;c>b;b++)g.push(f);this.handles=e.add(a(g.join("")).appendTo(this.element)),this.handle=this.handles.eq(0),this.handles.each(function(b){a(this).data("ui-slider-handle-index",b)})},_createRange:function(){var b=this.options,c="";b.range?(b.range===!0&&(b.values?b.values.length&&2!==b.values.length?b.values=[b.values[0],b.values[0]]:a.isArray(b.values)&&(b.values=b.values.slice(0)):b.values=[this._valueMin(),this._valueMin()]),this.range&&this.range.length?this.range.removeClass("ui-slider-range-min ui-slider-range-max").css({left:"",bottom:""}):(this.range=a("<div></div>").appendTo(this.element),c="ui-slider-range ui-widget-header ui-corner-all"),this.range.addClass(c+("min"===b.range||"max"===b.range?" ui-slider-range-"+b.range:""))):(this.range&&this.range.remove(),this.range=null)},_setupEvents:function(){this._off(this.handles),this._on(this.handles,this._handleEvents),this._hoverable(this.handles),this._focusable(this.handles)},_destroy:function(){this.handles.remove(),this.range&&this.range.remove(),this.element.removeClass("ui-slider ui-slider-horizontal ui-slider-vertical ui-widget ui-widget-content ui-corner-all"),this._mouseDestroy()},_mouseCapture:function(b){var c,d,e,f,g,h,i,j,k=this,l=this.options;return l.disabled?!1:(this.elementSize={width:this.element.outerWidth(),height:this.element.outerHeight()},this.elementOffset=this.element.offset(),c={x:b.pageX,y:b.pageY},d=this._normValueFromMouse(c),e=this._valueMax()-this._valueMin()+1,this.handles.each(function(b){var c=Math.abs(d-k.values(b));(e>c||e===c&&(b===k._lastChangedValue||k.values(b)===l.min))&&(e=c,f=a(this),g=b)}),h=this._start(b,g),h===!1?!1:(this._mouseSliding=!0,this._handleIndex=g,f.addClass("ui-state-active").focus(),i=f.offset(),j=!a(b.target).parents().addBack().is(".ui-slider-handle"),this._clickOffset=j?{left:0,top:0}:{left:b.pageX-i.left-f.width()/2,top:b.pageY-i.top-f.height()/2-(parseInt(f.css("borderTopWidth"),10)||0)-(parseInt(f.css("borderBottomWidth"),10)||0)+(parseInt(f.css("marginTop"),10)||0)},this.handles.hasClass("ui-state-hover")||this._slide(b,g,d),this._animateOff=!0,!0))},_mouseStart:function(){return!0},_mouseDrag:function(a){var b={x:a.pageX,y:a.pageY},c=this._normValueFromMouse(b);return this._slide(a,this._handleIndex,c),!1},_mouseStop:function(a){return this.handles.removeClass("ui-state-active"),this._mouseSliding=!1,this._stop(a,this._handleIndex),this._change(a,this._handleIndex),this._handleIndex=null,this._clickOffset=null,this._animateOff=!1,!1},_detectOrientation:function(){this.orientation="vertical"===this.options.orientation?"vertical":"horizontal"},_normValueFromMouse:function(a){var b,c,d,e,f;return"horizontal"===this.orientation?(b=this.elementSize.width,c=a.x-this.elementOffset.left-(this._clickOffset?this._clickOffset.left:0)):(b=this.elementSize.height,c=a.y-this.elementOffset.top-(this._clickOffset?this._clickOffset.top:0)),d=c/b,d>1&&(d=1),0>d&&(d=0),"vertical"===this.orientation&&(d=1-d),e=this._valueMax()-this._valueMin(),f=this._valueMin()+d*e,this._trimAlignValue(f)},_start:function(a,b){var c={handle:this.handles[b],value:this.value()};return this.options.values&&this.options.values.length&&(c.value=this.values(b),c.values=this.values()),this._trigger("start",a,c)},_slide:function(a,b,c){var d,e,f;this.options.values&&this.options.values.length?(d=this.values(b?0:1),2===this.options.values.length&&this.options.range===!0&&(0===b&&c>d||1===b&&d>c)&&(c=d),c!==this.values(b)&&(e=this.values(),e[b]=c,f=this._trigger("slide",a,{handle:this.handles[b],value:c,values:e}),d=this.values(b?0:1),f!==!1&&this.values(b,c))):c!==this.value()&&(f=this._trigger("slide",a,{handle:this.handles[b],value:c}),f!==!1&&this.value(c))},_stop:function(a,b){var c={handle:this.handles[b],value:this.value()};this.options.values&&this.options.values.length&&(c.value=this.values(b),c.values=this.values()),this._trigger("stop",a,c)},_change:function(a,b){if(!this._keySliding&&!this._mouseSliding){var c={handle:this.handles[b],value:this.value()};this.options.values&&this.options.values.length&&(c.value=this.values(b),c.values=this.values()),this._lastChangedValue=b,this._trigger("change",a,c)}},value:function(a){return arguments.length?(this.options.value=this._trimAlignValue(a),this._refreshValue(),void this._change(null,0)):this._value()},values:function(b,c){var d,e,f;if(arguments.length>1)return this.options.values[b]=this._trimAlignValue(c),this._refreshValue(),void this._change(null,b);if(!arguments.length)return this._values();if(!a.isArray(arguments[0]))return this.options.values&&this.options.values.length?this._values(b):this.value();for(d=this.options.values,e=arguments[0],f=0;d.length>f;f+=1)d[f]=this._trimAlignValue(e[f]),this._change(null,f);this._refreshValue()},_setOption:function(b,c){var d,e=0;switch("range"===b&&this.options.range===!0&&("min"===c?(this.options.value=this._values(0),this.options.values=null):"max"===c&&(this.options.value=this._values(this.options.values.length-1),this.options.values=null)),a.isArray(this.options.values)&&(e=this.options.values.length),"disabled"===b&&this.element.toggleClass("ui-state-disabled",!!c),this._super(b,c),b){case"orientation":this._detectOrientation(),this.element.removeClass("ui-slider-horizontal ui-slider-vertical").addClass("ui-slider-"+this.orientation),this._refreshValue();break;case"value":this._animateOff=!0,this._refreshValue(),this._change(null,0),this._animateOff=!1;break;case"values":for(this._animateOff=!0,this._refreshValue(),d=0;e>d;d+=1)this._change(null,d);this._animateOff=!1;break;case"min":case"max":this._animateOff=!0,this._refreshValue(),this._animateOff=!1;break;case"range":this._animateOff=!0,this._refresh(),this._animateOff=!1}},_value:function(){var a=this.options.value;return a=this._trimAlignValue(a)},_values:function(a){var b,c,d;if(arguments.length)return b=this.options.values[a],b=this._trimAlignValue(b);if(this.options.values&&this.options.values.length){for(c=this.options.values.slice(),d=0;c.length>d;d+=1)c[d]=this._trimAlignValue(c[d]);return c}return[]},_trimAlignValue:function(a){if(this._valueMin()>=a)return this._valueMin();if(a>=this._valueMax())return this._valueMax();var b=this.options.step>0?this.options.step:1,c=(a-this._valueMin())%b,d=a-c;return 2*Math.abs(c)>=b&&(d+=c>0?b:-b),parseFloat(d.toFixed(5))},_valueMin:function(){return this.options.min},_valueMax:function(){return this.options.max},_refreshValue:function(){var b,c,d,e,f,g=this.options.range,h=this.options,i=this,j=this._animateOff?!1:h.animate,k={};this.options.values&&this.options.values.length?this.handles.each(function(d){c=100*((i.values(d)-i._valueMin())/(i._valueMax()-i._valueMin())),k["horizontal"===i.orientation?"left":"bottom"]=c+"%",a(this).stop(1,1)[j?"animate":"css"](k,h.animate),i.options.range===!0&&("horizontal"===i.orientation?(0===d&&i.range.stop(1,1)[j?"animate":"css"]({left:c+"%"},h.animate),1===d&&i.range[j?"animate":"css"]({width:c-b+"%"},{queue:!1,duration:h.animate})):(0===d&&i.range.stop(1,1)[j?"animate":"css"]({bottom:c+"%"},h.animate),1===d&&i.range[j?"animate":"css"]({height:c-b+"%"},{queue:!1,duration:h.animate}))),b=c}):(d=this.value(),e=this._valueMin(),f=this._valueMax(),c=f!==e?100*((d-e)/(f-e)):0,k["horizontal"===this.orientation?"left":"bottom"]=c+"%",this.handle.stop(1,1)[j?"animate":"css"](k,h.animate),"min"===g&&"horizontal"===this.orientation&&this.range.stop(1,1)[j?"animate":"css"]({width:c+"%"},h.animate),"max"===g&&"horizontal"===this.orientation&&this.range[j?"animate":"css"]({width:100-c+"%"},{queue:!1,duration:h.animate}),"min"===g&&"vertical"===this.orientation&&this.range.stop(1,1)[j?"animate":"css"]({height:c+"%"},h.animate),"max"===g&&"vertical"===this.orientation&&this.range[j?"animate":"css"]({height:100-c+"%"},{queue:!1,duration:h.animate}))},_handleEvents:{keydown:function(b){var c,d,e,f,g=a(b.target).data("ui-slider-handle-index");switch(b.keyCode){case a.ui.keyCode.HOME:case a.ui.keyCode.END:case a.ui.keyCode.PAGE_UP:case a.ui.keyCode.PAGE_DOWN:case a.ui.keyCode.UP:case a.ui.keyCode.RIGHT:case a.ui.keyCode.DOWN:case a.ui.keyCode.LEFT:if(b.preventDefault(),!this._keySliding&&(this._keySliding=!0,a(b.target).addClass("ui-state-active"),c=this._start(b,g),c===!1))return}switch(f=this.options.step,d=e=this.options.values&&this.options.values.length?this.values(g):this.value(),b.keyCode){case a.ui.keyCode.HOME:e=this._valueMin();break;case a.ui.keyCode.END:e=this._valueMax();break;case a.ui.keyCode.PAGE_UP:e=this._trimAlignValue(d+(this._valueMax()-this._valueMin())/this.numPages);break;case a.ui.keyCode.PAGE_DOWN:e=this._trimAlignValue(d-(this._valueMax()-this._valueMin())/this.numPages);break;case a.ui.keyCode.UP:case a.ui.keyCode.RIGHT:if(d===this._valueMax())return;e=this._trimAlignValue(d+f);break;case a.ui.keyCode.DOWN:case a.ui.keyCode.LEFT:if(d===this._valueMin())return;e=this._trimAlignValue(d-f)}this._slide(b,g,e)},keyup:function(b){var c=a(b.target).data("ui-slider-handle-index");this._keySliding&&(this._keySliding=!1,this._stop(b,c),this._change(b,c),a(b.target).removeClass("ui-state-active"))}}})}),jQuery.cookie=function(a,b,c){if(arguments.length>1&&"[object Object]"!==String(b)){if(c=jQuery.extend({},c),(null===b||void 0===b)&&(c.expires=-1),"number"==typeof c.expires){var d=c.expires,e=c.expires=new Date;e.setDate(e.getDate()+d)}return b=String(b),document.cookie=[encodeURIComponent(a),"=",c.raw?b:encodeURIComponent(b),c.expires?"; expires="+c.expires.toUTCString():"",c.path?"; path="+c.path:"",c.domain?"; domain="+c.domain:"",c.secure?"; secure":""].join("")}c=b||{};var f,g=c.raw?function(a){return a}:decodeURIComponent;return(f=new RegExp("(?:^|; )"+encodeURIComponent(a)+"=([^;]*)").exec(document.cookie))?g(f[1]):null},function(a){"use strict";var b={init:function(){b.interfaceAppend(),b.overlayChange(),b.overlayToggle(),b.overlayDrag(),b.overlayPosition(),b.overlayOpacity(),b.pageOpacity(),b.overlayFineTuning(),b.overUnderToggle(),b.interfaceDrag(),b.interfaceToggle()},overlayChange:function(){a("#xprecise-image").bind("change",function(){a("#xprecise-overlay img").attr("src",a(this).val()),b.saveSettings()})},overlayToggle:function(){function c(){"On"===d.text()?(d.text("Off"),d.addClass("xprecise-off")):(d.text("On"),d.removeClass("xprecise-off")),e.toggle(),b.saveSettings()}var d=a("#xprecise a.xprecise-toggle"),e=a("#xprecise-overlay"),f=!1;d.bind("click",function(){return c(),!1}),a(document).keyup(function(a){18==a.which&&(f=!1)}),a(document).keydown(function(a){18==a.which&&(f=!0),81==a.which&&f&&c()}),"Off"===d.text()&&(e.hide(),d.addClass("xprecise-off"))},overlayDrag:function(){a("#xprecise-overlay").draggable({drag:function(b,c){a("#xprecise-top").val(c.position.top),a("#xprecise-left").val(c.position.left)},stop:function(){b.saveSettings()}})},overlayPosition:function(){var c=a("#xprecise-overlay"),d=a("#xprecise-top"),e=a("#xprecise-left");d.bind("change",function(){c.css("top",a(this).val()+"px"),b.saveSettings()}),e.bind("change",function(){c.css("left",a(this).val()+"px"),b.saveSettings()}),c.css("top",d.val()+"px"),c.css("left",e.val()+"px")},overlayFineTuning:function(){function c(a){var c=1*f.val()-1;"down"===a&&(c=1*f.val()+1),f.val(c),e.css("top",c+"px"),b.saveSettings()}function d(a){var c=1*g.val()-1;"right"===a&&(c=1*g.val()+1),g.val(c),e.css("left",c+"px"),b.saveSettings()}var e=a("#xprecise-overlay"),f=a("#xprecise-top"),g=a("#xprecise-left");e.hover(function(){a(document).unbind("keypress.xprecise"),a(document).bind("keydown.xprecise",function(a){switch(a.keyCode){case 87:c("up");break;case 83:c("down");break;case 65:d("left");break;case 68:d("right")}})},function(){a(document).unbind("keydown.xprecise")})},overlayOpacity:function(){var c=a("#xprecise-overlay"),d=a("#xprecise-opacity-value"),e=1*d.text();c.css("opacity",e/100),a("#xprecise-opacity").slider({value:e,slide:function(a,b){d.text(b.value),c.css("opacity",b.value/100)},stop:function(){b.saveSettings()}})},pageOpacity:function(){var c=a("#xprecise-wrapper"),d=a("#xprecise-page-opacity-value"),e=1*d.text();c.css("opacity",e/100),a("#xprecise-page-opacity").slider({value:e,slide:function(a,b){d.text(b.value),c.css("opacity",b.value/100)},stop:function(){b.saveSettings()}})},overUnderToggle:function(){var c=a("#xprecise-overlay");a("#xprecise-over").bind("click",function(){c.css("z-index",1e4),b.saveSettings()}),a("#xprecise-under").bind("click",function(){c.css("z-index",1e3),b.saveSettings()}),a("#xprecise-over").is(":checked")?c.css("z-index",1e4):c.css("z-index",1e3)},getInterfacePosition:function(){var b=a("#xprecise").offset(),c=b.top-a(window).scrollTop(),d=b.left-a(window).scrollLeft(),e=a(window).height(),f=a(window).width(),g=e-35,h=f-200;return b.top=c,b.left=d,c>g&&(b.top=g,a("#xprecise").css("top",b.top)),0>c&&(b.top=0,a("#xprecise").css("top",b.top)),d>h&&(b.left=h,a("#xprecise").css("left",b.left)),0>d&&(b.left=0,a("#xprecise").css("left",b.left)),b},interfaceDrag:function(){a("#xprecise").draggable({handle:"h2",stop:function(){b.saveSettings()}})},interfaceToggle:function(){function c(){var c=a("#xprecise a.xprecise-close");d.toggle(),"–"===c.text()?(c.text("+"),c.addClass("xprecise-closed")):(c.text("–"),c.removeClass("xprecise-closed")),b.saveSettings()}var d=a("#xprecise form"),e=a("#xprecise a.xprecise-close");a("#xprecise a.xprecise-close").bind("click",function(){return c(),!1}),a("#xprecise h2").bind("dblclick",function(){c()}),"+"===e.text()&&(d.hide(),e.addClass("xprecise-closed"))},getImageFromURL:function(){var a="",b=location.pathname.split("/");return b.reverse(),a=""!==b[0]?"designs/"+b[0].replace(/(.html|.php)/,".jpg"):"designs/index.jpg"},saveSettings:function(){var c,d,e,f="|";c="–"===a("#xprecise a.xprecise-close").text()?"–":"+",d="On"===a("#xprecise a.xprecise-toggle").text()?"On":"Off";var g=this.getInterfacePosition();e=a("#xprecise-over").is(":checked")?"over":"under";var h=c+f+g.top+f+g.left+f+d+f+a("#xprecise-image").val()+f+a("#xprecise-top").val()+f+a("#xprecise-left").val()+f+a("#xprecise-opacity-value").text()+f+a("#xprecise-page-opacity-value").text()+f+e,i=b.getCookieInfo();a.cookie(i.cookie_name,h,{path:i.cookie_path,expires:365})},getCookieInfo:function(){var a=[],b=location.pathname.split("/"),c=b.pop();return a.cookie_path=b.join("/")+"/",a.cookie_name="xprecise_"+c,a},loadSettings:function(){var c=[],d=b.getCookieInfo();if(a.cookie(d.cookie_name)){var e=a.cookie(d.cookie_name).split("|");c.interface=e[0],c.interface_top=e[1],c.interface_left=e[2],c.overlay=e[3],c.image=e[4],c.overlay_top=e[5],c.overlay_left=e[6],c.overlay_opacity=e[7],c.page_opacity=e[8],c.over_under=e[9]}else c.interface="+",c.interface_top=20,c.interface_left=20,c.overlay="Off",c.image=b.getImageFromURL(),c.overlay_top=0,c.overlay_left=0,c.overlay_opacity=50,c.page_opacity=100,c.over_under="over";return c},checkExtension:function(a){var b=new XMLHttpRequest;if(b.open("HEAD",a,!1),b.send(),this.onerror=function(){},404==b.status&&a.match(/.jpg/)){var c=a.replace(/.jpg/,".png"),d=new XMLHttpRequest;d.open("HEAD",c,!1),d.send(),404!=d.status&&(a=c)}return a},isCanvasSupported:function(){var a=document.createElement("canvas");return!(!a.getContext||!a.getContext("2d"))},interfaceAppend:function(){var c,d,e=this.loadSettings();"over"===e.over_under?(c=' checked="checked" ',d=""):(d=' checked="checked" ',c=""),e.image=b.checkExtension(e.image);var f=a("body");a("head").append('<link rel="stylesheet" type="text/css" media="all" href="http://xhtmlized.github.io/x-precise/xprecise.min.css" />'),f.children().not("script").wrapAll('<div id="xprecise-wrapper"></div>'),f.append('<div id="xprecise-overlay"><img src="'+e.image+'" alt="X-Precise Overlay" /></div>'),f.append('<div id="xprecise"> <h2><img src="http://xhtmlized.github.io/x-precise/img/x.png" width="14" height="14" alt="X" /> - Precise <span><a href="#" class="xprecise-toggle">'+e.overlay+'</a> <a href="#" class="xprecise-close">'+e.interface+'</a></span></h2> <form action="#"> <div> <h3><label for="xprecise-image" class="design">Design</label> <span> <input type="radio" name="xprecise-switch" id="xprecise-over" '+c+' />    <label for="xprecise-over">over</label>    <input type="radio" name="xprecise-switch" id="xprecise-under" '+d+' />    <label for="xprecise-under">under</label></span></h3> <input type="text" value="'+e.image+'" id="xprecise-image" /> </div> <div> <h3>Position</h3> <label for="xprecise-top">top</label> <input type="text" value="'+e.overlay_top+'" id="xprecise-top" size="4" /> <label for="xprecise-left">left</label> <input type="text" value="'+e.overlay_left+'" id="xprecise-left" size="4" /> </div> <div>    <h3>Design opacity <span><span id="xprecise-opacity-value">'+e.overlay_opacity+'</span>%</span></h3> <div class="xprecise-slider"> <div id="xprecise-opacity"></div> </div> </div> <div> <h3>Page opacity <span> <span id="xprecise-page-opacity-value">'+e.page_opacity+'</span>%</span>    </h3> <div class="xprecise-slider"> <div id="xprecise-page-opacity"></div> </div> </div> </form> </div>'),a("#xprecise-overlay").css("position","absolute"),a("#xprecise").css("top",e.interface_top+"px"),a("#xprecise").css("left",e.interface_left+"px"),b.isCanvasSupported()||a("#xprecise").addClass("oldies")}};a(function(){b.init()})}(jQuery);